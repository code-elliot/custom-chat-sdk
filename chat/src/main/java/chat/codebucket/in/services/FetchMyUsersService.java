package chat.codebucket.in.services;
...
public class FetchMyUsersService extends IntentService {
    ...
    private void fetchMyUsers() {
        ...
        try {
            ...
            URL url = new URL(FirebaseDatabase.getInstance().getReference().toString() + "/" + Helper.REF_USERS + ".json");
